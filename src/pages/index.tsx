  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to Expense Tracker - Your reliable partner in maintaining and managing your monthly expenses efficiently and effectively."
        />
      </Head>
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1634733988138-bf2c3a2a13fa?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxleHBlbnNlfGVufDB8fHx8MTY4OTk5MDA3Nnww&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to Expense Tracker - Your reliable partner in maintaining and managing your monthly expenses efficiently and effectively.`}
            </Text>
            <Box
